...
### New Recipe
- [ ] Create Recipe + Create & Log Recipe
- [ ] Instructions 
...
## Profile
- [ ] The body info using slide bar?
- [ ] Weekly Budget and Daily Macro Goals also being possible to write the number instead of only +/-
