...
export const PREDEFINED_RECIPES: Recipe[] = [
  {
    id: 'r1', name: 'Quinoa Power Bowl', mealType: 'Lunch',
    ...
    ingredients: [
      ...
      { ingredientId: 'i4',  name: 'Coconut Milk', brand: 'Naturas', weightG: 80, selectedStore: 'lidl', pricePerKg: 1.39 },
      { ingredientId: 'i12', name: 'Chicken Breast', brand: 'Fresh', weightG: 100, selectedStore: 'pingo_doce', pricePerKg: 8.49 },
    ],
  },
  {
    id: 'r2', name: 'Greek Chicken Bowl', mealType: 'Dinner',
  ...
  {
    id: 'r3', name: 'Avocado Toast', mealType: 'Breakfast',
  ...
  {
    id: 'r4', name: 'Salmon & Sweet Potato', mealType: 'Dinner',
    dietTags: ['High Protein', 'Keto'],
    macros: { calories: 580, protein: 44, carbs: 52, fat: 22 },
    cost: 5.60, isCustom: false,
    ingredients: [
      { ingredientId: 'i6', name: 'Atlantic Salmon', brand: 'Continente', weightG: 200, selectedStore: 'lidl', pricePerKg: 12.99 },
    ],
  },
  {
    id: 'r5', name: 'Overnight Oats', mealType: 'Breakfast',
    dietTags: ['Vegan'],
  ...
  {
    id: 'r6', name: 'Egg & Veggie Scramble', mealType: 'Breakfast',
    dietTags: ['Keto', 'Low Carb', 'High Protein'],
    macros: { calories: 290, protein: 20, carbs: 8, fat: 18 },
    cost: 1.80, isCustom: false,
    ingredients: [
      { ingredientId: 'i11', name: 'Free Range Eggs', brand: 'Continente Bio', weightG: 150, selectedStore: 'lidl', pricePerKg: 2.49 },
    ],
  },
  {
    id: 'r7', name: 'Lentil Soup', mealType: 'Lunch',
  ...
  {
    id: 'r8', name: 'Tuna Rice Bowl', mealType: 'Lunch',
    dietTags: ['High Protein', 'Low Carb'],
    macros: { calories: 430, protein: 38, carbs: 48, fat: 7 },
    cost: 2.80, isCustom: false,
    ingredients: [
      { ingredientId: 'i15', name: 'Tuna Can', brand: 'Rio Mare', weightG: 150, selectedStore: 'lidl', pricePerKg: 1.99 },
      { ingredientId: 'i7',  name: 'Jasmine Rice', brand: 'Continente', weightG: 150, selectedStore: 'lidl', pricePerKg: 1.09 },
    ],
  },
];